...
public class User implements UserDetails, Serializable {
    ...
    @Length(min = 5, max = 20, message = "O Tamanho do usuário deve ser entre {min} e {max} caracteres!")
    @Column(name = "user_name", unique = true)
    private String userName;

    @NotNull(message = "O nome completo não pode ser vazio!")
    @Length(min = 10, max = 50, message = "O Tamanho do usuário deve ser entre {min} e {max} caracteres!")
